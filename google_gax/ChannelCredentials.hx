...
**/
@:jsRequire("google-gax", "ChannelCredentials") extern class ChannelCredentials {
	private function new(?callCredentials:grpc.grpc_js.CallCredentials);
	private var callCredentials : grpc.grpc_js.CallCredentials;
	/**
		Returns a copy of this object with the included set of per-call credentials
		expanded to include callCredentials.
	**/
	function compose(callCredentials:grpc.grpc_js.CallCredentials):ChannelCredentials;
	/**
		Gets the set of per-call credentials associated with this instance.
	**/
	function _getCallCredentials():grpc.grpc_js.CallCredentials;
	/**
