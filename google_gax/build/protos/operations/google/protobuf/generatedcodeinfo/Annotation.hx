package google_gax.build.protos.operations.google.protobuf.generatedcodeinfo;

/**
	Represents an Annotation.
**/
@:jsRequire("google-gax/build/protos/operations", "google.protobuf.GeneratedCodeInfo.Annotation") extern class Annotation {
	/**
