...
**/
@:jsRequire("google-gax/build/protos/operations", "google.protobuf.UninterpretedOption") extern class UninterpretedOption {
	/**
	...
	**/
	public var name : Array<google_gax.build.protos.operations.google.protobuf.uninterpretedoption.INamePart>;
	/**
