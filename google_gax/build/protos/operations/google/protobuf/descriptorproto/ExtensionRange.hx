package google_gax.build.protos.operations.google.protobuf.descriptorproto;

/**
	Represents an ExtensionRange.
**/
@:jsRequire("google-gax/build/protos/operations", "google.protobuf.DescriptorProto.ExtensionRange") extern class ExtensionRange {
	/**
	...
	**/
	@:optional
	public var options : google_gax.build.protos.operations.google.protobuf.IExtensionRangeOptions;
	/**
