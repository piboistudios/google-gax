...
typedef IDescriptorProto = {
	...
	**/
	@:optional
	var extensionRange : Array<google_gax.build.protos.operations.google.protobuf.descriptorproto.IExtensionRange>;
	/**
	...
	**/
	@:optional
	var reservedRange : Array<google_gax.build.protos.operations.google.protobuf.descriptorproto.IReservedRange>;
	/**
