...
**/
@:jsRequire("google-gax/build/protos/operations", "google.protobuf.SourceCodeInfo") extern class SourceCodeInfo {
	/**
	...
	**/
	public var location : Array<google_gax.build.protos.operations.google.protobuf.sourcecodeinfo.ILocation>;
	/**
