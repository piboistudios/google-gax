package google_gax.build.protos.operations.google.protobuf.uninterpretedoption;

/**
	Represents a NamePart.
**/
@:jsRequire("google-gax/build/protos/operations", "google.protobuf.UninterpretedOption.NamePart") extern class NamePart {
	/**
