...
**/
@:jsRequire("google-gax/build/protos/operations", "google.protobuf.GeneratedCodeInfo") extern class GeneratedCodeInfo {
	/**
	...
	**/
	public var annotation : Array<google_gax.build.protos.operations.google.protobuf.generatedcodeinfo.IAnnotation>;
	/**
