...
**/
@:jsRequire("google-gax/build/protos/operations", "google.protobuf.FileOptions") extern class FileOptions {
	/**
	...
	**/
	public var optimizeFor : google_gax.build.protos.operations.google.protobuf.fileoptions.OptimizeMode;
	/**
