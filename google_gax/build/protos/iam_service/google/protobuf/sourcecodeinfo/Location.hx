package google_gax.build.protos.iam_service.google.protobuf.sourcecodeinfo;

/**
	Represents a Location.
**/
@:jsRequire("google-gax/build/protos/iam_service", "google.protobuf.SourceCodeInfo.Location") extern class Location {
	/**
