...
**/
@:jsRequire("google-gax/build/protos/iam_service", "google.protobuf.SourceCodeInfo") extern class SourceCodeInfo {
	/**
	...
	**/
	public var location : Array<google_gax.build.protos.iam_service.google.protobuf.sourcecodeinfo.ILocation>;
	/**
