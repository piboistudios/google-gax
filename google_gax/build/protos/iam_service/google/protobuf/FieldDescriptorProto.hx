...
**/
@:jsRequire("google-gax/build/protos/iam_service", "google.protobuf.FieldDescriptorProto") extern class FieldDescriptorProto {
	/**
	...
	**/
	public var label : google_gax.build.protos.iam_service.google.protobuf.fielddescriptorproto.Label;
	/**
		FieldDescriptorProto type.
	**/
	public var type : google_gax.build.protos.iam_service.google.protobuf.fielddescriptorproto.Type_;
	/**
