...
**/
@:jsRequire("google-gax/build/protos/iam_service", "google.protobuf.EnumDescriptorProto") extern class EnumDescriptorProto {
	/**
	...
	**/
	public var reservedRange : Array<google_gax.build.protos.iam_service.google.protobuf.enumdescriptorproto.IEnumReservedRange>;
	/**
