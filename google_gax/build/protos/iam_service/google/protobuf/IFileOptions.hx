...
typedef IFileOptions = {
	...
	**/
	@:optional
	var optimizeFor : google_gax.build.protos.iam_service.google.protobuf.fileoptions.OptimizeMode;
	/**
	...
	**/
	...
	var _google_api_resourceDefinition : Array<google_gax.build.protos.iam_service.google.api.IResourceDescriptor>;
};