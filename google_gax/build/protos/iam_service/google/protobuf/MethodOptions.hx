...
**/
@:jsRequire("google-gax/build/protos/iam_service", "google.protobuf.MethodOptions") extern class MethodOptions {
	/**
	...
	**/
	public var idempotencyLevel : google_gax.build.protos.iam_service.google.protobuf.methodoptions.IdempotencyLevel;
	/**
