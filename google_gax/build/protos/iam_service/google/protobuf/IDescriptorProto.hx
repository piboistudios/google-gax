...
typedef IDescriptorProto = {
	...
	**/
	@:optional
	var extensionRange : Array<google_gax.build.protos.iam_service.google.protobuf.descriptorproto.IExtensionRange>;
	/**
	...
	**/
	@:optional
	var reservedRange : Array<google_gax.build.protos.iam_service.google.protobuf.descriptorproto.IReservedRange>;
	/**
