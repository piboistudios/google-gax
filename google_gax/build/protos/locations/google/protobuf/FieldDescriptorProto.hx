...
**/
@:jsRequire("google-gax/build/protos/locations", "google.protobuf.FieldDescriptorProto") extern class FieldDescriptorProto {
	/**
	...
	**/
	public var label : google_gax.build.protos.locations.google.protobuf.fielddescriptorproto.Label;
	/**
		FieldDescriptorProto type.
	**/
	public var type : google_gax.build.protos.locations.google.protobuf.fielddescriptorproto.Type_;
	/**
