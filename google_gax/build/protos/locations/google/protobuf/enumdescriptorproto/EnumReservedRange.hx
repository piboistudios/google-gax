package google_gax.build.protos.locations.google.protobuf.enumdescriptorproto;

/**
	Represents an EnumReservedRange.
**/
@:jsRequire("google-gax/build/protos/locations", "google.protobuf.EnumDescriptorProto.EnumReservedRange") extern class EnumReservedRange {
	/**
