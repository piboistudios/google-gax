...
typedef IMethodOptions = {
	...
	**/
	@:optional
	var idempotencyLevel : google_gax.build.protos.locations.google.protobuf.methodoptions.IdempotencyLevel;
	/**
	...
	**/
	...
	var _google_api_http : google_gax.build.protos.locations.google.api.IHttpRule;
	/**
