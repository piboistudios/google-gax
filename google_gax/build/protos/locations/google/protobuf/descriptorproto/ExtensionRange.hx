...
**/
@:jsRequire("google-gax/build/protos/locations", "google.protobuf.DescriptorProto.ExtensionRange") extern class ExtensionRange {
	/**
	...
	**/
	@:optional
	public var options : google_gax.build.protos.locations.google.protobuf.IExtensionRangeOptions;
	/**
