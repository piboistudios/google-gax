package google_gax.build.protos.locations.google.protobuf.generatedcodeinfo;

/**
	Represents an Annotation.
**/
@:jsRequire("google-gax/build/protos/locations", "google.protobuf.GeneratedCodeInfo.Annotation") extern class Annotation {
	/**
