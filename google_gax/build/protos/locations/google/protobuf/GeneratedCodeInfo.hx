...
**/
@:jsRequire("google-gax/build/protos/locations", "google.protobuf.GeneratedCodeInfo") extern class GeneratedCodeInfo {
	/**
	...
	**/
	public var annotation : Array<google_gax.build.protos.locations.google.protobuf.generatedcodeinfo.IAnnotation>;
	/**
