...
**/
@:jsRequire("google-gax/build/protos/locations", "google.protobuf.MethodOptions") extern class MethodOptions {
	/**
	...
	**/
	public var idempotencyLevel : google_gax.build.protos.locations.google.protobuf.methodoptions.IdempotencyLevel;
	/**
