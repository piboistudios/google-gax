...
**/
@:jsRequire("google-gax/build/protos/locations", "google.protobuf.EnumDescriptorProto") extern class EnumDescriptorProto {
	/**
	...
	**/
	public var reservedRange : Array<google_gax.build.protos.locations.google.protobuf.enumdescriptorproto.IEnumReservedRange>;
	/**
