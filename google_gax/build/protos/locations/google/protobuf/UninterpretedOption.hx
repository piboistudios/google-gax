...
**/
@:jsRequire("google-gax/build/protos/locations", "google.protobuf.UninterpretedOption") extern class UninterpretedOption {
	/**
	...
	**/
	public var name : Array<google_gax.build.protos.locations.google.protobuf.uninterpretedoption.INamePart>;
	/**
