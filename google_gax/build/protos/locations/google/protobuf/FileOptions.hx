...
**/
@:jsRequire("google-gax/build/protos/locations", "google.protobuf.FileOptions") extern class FileOptions {
	/**
	...
	**/
	public var optimizeFor : google_gax.build.protos.locations.google.protobuf.fileoptions.OptimizeMode;
	/**
