package google_gax.build.protos.locations.google.protobuf.uninterpretedoption;

/**
	Represents a NamePart.
**/
@:jsRequire("google-gax/build/protos/locations", "google.protobuf.UninterpretedOption.NamePart") extern class NamePart {
	/**
