package google_gax.build.protos.locations.google.protobuf.sourcecodeinfo;

/**
	Represents a Location.
**/
@:jsRequire("google-gax/build/protos/locations", "google.protobuf.SourceCodeInfo.Location") extern class Location {
	/**
